" Sarnath
" 256-color terminal colorscheme for vim
...
"
" -Howard Phillips Lovecraft, The Doom That Came to Sarnath
...
let s:browngray = '101'
let s:paleblue = '109'
let s:lightorange = '179'

let s:constant = s:browngray
let s:statement = s:paleblue
let s:identifier = s:lightorange
let s:preproc = s:paleblue

exe "hi! Normal cterm=".s:none." ctermfg=".s:none." ctermbg=".s:none
exe "hi! Cursor cterm=".s:none." ctermfg=".s:green." ctermbg=".s:green
exe "hi! Statement cterm=".s:bold." ctermfg=".s:statement." ctermbg=".s:none
